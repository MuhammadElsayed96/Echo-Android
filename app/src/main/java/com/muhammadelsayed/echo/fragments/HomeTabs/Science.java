...
import static com.muhammadelsayed.echo.activities.SplashActivity.mScienceArticleList;
...
public class Science extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mScienceRecycler = rootView.findViewById(R.id.recycler);
        ...
        mScienceRecycler.setItemViewCacheSize(100);
        ...
        loadScienceData();
        mScienceRecycler.addOnScrollListener(new EndlessRecyclerOnScrollListener() {
            @Override
    ...
    private void addDataToList(int page) {
        ...
        Utils.getNews(options, new Utils.retrofitCallback() {
            ...
            public void onSuccess(List<Article> articles) {
                ...
                mScienceArticleList.addAll(articles);
                mScienceNewsAdapter.notifyDataSetChanged();
            ...
            if (isNetworkAvailable()) {
                ...
                Utils.getNews(options, new Utils.retrofitCallback() {
                    ...
                    public void onSuccess(List<Article> articles) {
                        ...
                        mScienceNewsAdapter = new NewsAdapter(getContext(), mScienceArticleList);
    ...
    public void onRefresh() {
        ...
        if (isNetworkAvailable()) {
            ...
            Log.wtf(TAG, "onRefresh()::mScienceArticleList = " + mScienceArticleList.toString());
            loadScienceData();
