...
import static com.muhammadelsayed.echo.activities.SplashActivity.mUkNewsArticleList;
import static com.muhammadelsayed.echo.activities.SplashActivity.mUsNewsArticleList;
...
public class UsHeadlines extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mUsHeadlinesRecycler = rootView.findViewById(R.id.recycler);
        ...
        loadUsHeadlinesData();
        mUsHeadlinesRecycler.addOnScrollListener(new EndlessRecyclerOnScrollListener() {
            @Override
    ...
    private void addDataToList(int page) {
        ...
        Utils.getNews(options, new Utils.retrofitCallback() {
            ...
            public void onSuccess(List<Article> articles) {
                ...
                mUsNewsArticleList.addAll(articles);
                mUsHeadlinesNewsAdapter.notifyDataSetChanged();
