...
import static com.muhammadelsayed.echo.activities.SplashActivity.mTravelArticleList;
...
public class Travel extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mTravelRecycler = rootView.findViewById(R.id.recycler);
        ...
        loadTravelData();
        mTravelRecycler.addOnScrollListener(new EndlessRecyclerOnScrollListener() {
            @Override
    ...
    private void addDataToList(int page) {
        ...
        Utils.getNews(options, new Utils.retrofitCallback() {
            ...
            public void onSuccess(List<Article> articles) {
                ...
                mTravelArticleList.addAll(articles);
                mTravelNewsAdapter.notifyDataSetChanged();
