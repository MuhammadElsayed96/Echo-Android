...
public class NewsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static String formatTime(String tripTime) throws ParseException {
        String pattern = getString(R.string.news_adapter_date_pattern);
...
//            case TYPE_ITEM:
        final View itemViewNormal = LayoutInflater.from(parent.getContext()).inflate(R.layout.normal_news_item, parent, false);
...
//        }
    ...
    private class NewsAdapterViewHolder extends RecyclerView.ViewHolder {
        ...
        private NewsAdapterViewHolder(View view) {
            //  It caches the views, by calling super(view);
            super(view);
