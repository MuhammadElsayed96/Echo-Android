...
//  private static List<Article> articles = new ArrayList<>();
    ...
    public static void getTopHeadLines(Map<String, Object> options, final retrofitCallbackArticle callback) {
    ...
    public static void getEverything(Map<String, Object> options, final retrofitCallbackArticle callback) {
        NewsClient service = RetrofitClientInstance.getRetrofitInstance().create(NewsClient.class);
    ...
    public static void getSources(Map<String, Object> options, final retrofitCallbackSource callback) {
        NewsClient service = RetrofitClientInstance.getRetrofitInstance().create(NewsClient.class);
        ...
        call.enqueue(
                new Callback<ResultSources>() {
                    ...
                    public void onResponse(Call<ResultSources> call, Response<ResultSources> response) {
                        Log.wtf(TAG, "getEverything()::onResponse(): Has been instantiated");
                        if (response.body().getStatus().equals("ok")) {
                            List<Source> sources = Arrays.asList(response.body().getSources());
