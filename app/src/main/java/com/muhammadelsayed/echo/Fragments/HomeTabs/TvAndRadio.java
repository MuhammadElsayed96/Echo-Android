...
public class TvAndRadio extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mTvAndRadioRecycler = rootView.findViewById(R.id.tv_radio_recycler);
        LinearLayoutManager mLinearLayoutManager =
                new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        mTvAndRadioRecycler.setLayoutManager(mLinearLayoutManager);
        mSwipeRefreshLayout = rootView.findViewById(R.id.tv_radio_swipe);
        ...
        if (mTvAndRadioArticleList.isEmpty()) {
            ...
            Utils.getNews(options, new Utils.retrofitCallback() {
                ...
                public void onSuccess(List<Article> articles) {
                    ...
                    mTvAndRadioNewsAdapter = new NewsAdapter(getContext(), mTvAndRadioArticleList, new NewsAdapter.ItemClickListener() {
                        @Override
                        public void onItemClick(View v, int position) {
                            Article currentArticle = mTvAndRadioArticleList.get(position);
            ...
            mTvAndRadioNewsAdapter =
                    new NewsAdapter(
                            getContext(),
                            mTvAndRadioArticleList,
