...
import static com.muhammadelsayed.echo.SplashActivity.mCultureArticleList;
...
public class Culture extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mCultureRecycler.setItemViewCacheSize(100);
    ...
    private void loadCultureData() {
        Log.wtf(TAG, "loadCultureData() has been instantiated");
        if (mCultureArticleList.isEmpty()) {
            ...
            Utils.getNews(options, new Utils.retrofitCallback() {
                ...
                public void onSuccess(List<Article> articles) {
                    ...
                    mCultureNewsAdapter = new NewsAdapter(getContext(), mCultureArticleList, new NewsAdapter.ItemClickListener() {
                        @Override
                        public void onItemClick(View v, int position) {
                            Article currentArticle = mCultureArticleList.get(position);
                    ...
                    mCultureRecycler.setAdapter(mCultureNewsAdapter);
                }
