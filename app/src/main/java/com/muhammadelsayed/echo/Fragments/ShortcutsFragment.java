 ...
 * Use the {@link ShortcutsFragment#shortcutsFragmentInstance} factory method to
...
public class ShortcutsFragment extends Fragment {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ShortcutsFragment1());
        adapter.addFragment(new ShortcutsFragment3());
        adapter.addFragment(new ShortcutsFragment2());
