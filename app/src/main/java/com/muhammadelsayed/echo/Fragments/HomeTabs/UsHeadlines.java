        ...
        if (mUkNewsArticleList.isEmpty()) {
            ...
            Utils.getNews(options, new Utils.retrofitCallback() {
                ...
                public void onSuccess(List<Article> articles) {
                    ...
                    mUsHeadlinesNewsAdapter = new NewsAdapter(getContext(), mUkNewsArticleList, new NewsAdapter.ItemClickListener() {
                        @Override
                        public void onItemClick(View v, int position) {
                            Article currentArticle = mUkNewsArticleList.get(position);
