        ...
        if (mLifestyleArticleList.isEmpty()) {
            ...
            Utils.getNews(options, new Utils.retrofitCallback() {
                ...
                public void onSuccess(List<Article> articles) {
                    ...
                    mLifestyleNewsAdapter = new NewsAdapter(getContext(), mLifestyleArticleList, new NewsAdapter.ItemClickListener() {
                        @Override
                        public void onItemClick(View v, int position) {
                            Article currentArticle = mLifestyleArticleList.get(position);
            ...
            mLifestyleNewsAdapter =
                    new NewsAdapter(
                            getContext(),
                            mLifestyleArticleList,
