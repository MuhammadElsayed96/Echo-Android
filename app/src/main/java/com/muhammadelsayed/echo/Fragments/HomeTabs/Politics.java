        ...
        if (mPoliticsArticleList.isEmpty()) {
            ...
            Utils.getNews(options, new Utils.retrofitCallback() {
                ...
                public void onSuccess(List<Article> articles) {
                    ...
                    mPoliticsNewsAdapter = new NewsAdapter(getContext(), mPoliticsArticleList, new NewsAdapter.ItemClickListener() {
                        @Override
                        public void onItemClick(View v, int position) {
                            Article currentArticle = mPoliticsArticleList.get(position);
            ...
            mPoliticsNewsAdapter =
                    new NewsAdapter(
                            getContext(),
                            mPoliticsArticleList,
